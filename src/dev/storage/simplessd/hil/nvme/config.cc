  ...
  if (MATCH_NAME(NAME_PCIE_GEN)) {
    switch (strtoul(value, nullptr, 10)) {
      ...
      case 2:
        ...
        break;
      default:
        ssd_panic("Invalid PCI Express Generation");
        break;
    }
  }
    ...
    switch (strtoul(value, nullptr, 10)) {
      ...
      case 5:
        ...
        break;
      default:
        ssd_panic("Invalid AXI Stream Bus Width");
        break;
    }
  }
...
void Config::update() {
  if (popcount(lbaSize) != 1 || lbaSize < 512) {
    ssd_panic("Invalid LBA size");
  }
  if (maxRequestCount == 0) {
    ssd_panic("MaxRequestCount should be larger then 0");
  }
  if (fifoUnit > 4096) {
    ssd_panic("FIFOTransferUnit should be less than or equal to 4096");
  }
}
