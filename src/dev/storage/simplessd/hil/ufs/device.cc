        ...
        case IDN_UNIT: {
          ...
          switch (req->header.lun) {
            ...
            case 0x00:
              ...
              break;
            default:
              ssd_warn("Unknown LUN 0x%2X", req->header.lun);
          }
        ...
        case IDN_STRING: {
          ...
          switch (req->index) {
            ...
            case STRING_PRODUCT_REVISION_LEVEL:
              ...
              break;
            default:
              ssd_warn("Unknown string index %#x", req->index);

              break;
          }
        } break;
        default:
          ssd_warn("Not implemented descriptor idn %#x", req->idn);

          break;
      }
    } break;
    default:
      ssd_warn("Not implemented query opcode %#x", req->opcode);
...
void Device::processCommand(UTP_TRANSFER_CMD cmd, UPIUCommand *req,
  ...
  switch (cmd) {
      ...
      switch (opcode) {
        ...
        case CMD_MODE_SENSE_10: {
          ...
          switch (req->cdb[2] & 0x3F) {
            ...
            default:
              ssd_warn("Not implemented mode page %#x", req->cdb[2] & 0x3F);
              buffer = nullptr;
              break;
          }
        ...
        case CMD_REPORT_LUNS: {
          ...
          if (sel == 0) {
            ...
            ssd_warn("Unknown select report field %#x", sel);
          }
        ...
        default:
          ssd_warn("Not implemented SCSI command %#x", opcode);
          break;
      }
    ...
    case CMD_DEVICE_MGMT_FUNCTION:
      ...
      ssd_warn("Device management function on UPIU Command is not "
           "defined operation");
      break;
  }
}
